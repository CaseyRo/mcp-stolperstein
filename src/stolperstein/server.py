...
def _build_auth():
    ...
    if not settings.keycloak_client_secret:
        ...
        logging.getLogger(__name__).warning(
            "KEYCLOAK_CLIENT_SECRET not set — OIDC proxy auth disabled"
        )
        return None
